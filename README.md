...
| [@docen/markdown](./packages/markdown/README.md)            | ![npm](https://img.shields.io/npm/v/@docen/markdown)    | Markdown syntax layer — neutral IR + renderer, format mappers bind their own model         |
