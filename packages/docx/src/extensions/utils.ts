...
export function hasLeaderTabStop(tabStops: unknown): boolean {
...
export function renderTextBlock(
  ...
  // default style's rule under that selector too.
  ...
  if (level != null && level >= 7) attrs["data-heading-level"] = String(level);
  return [tag, attrs, 0];
}
