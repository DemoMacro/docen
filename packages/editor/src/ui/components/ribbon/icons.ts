...
import textBold from "@fluentui/svg-icons/icons/text_bold_24_regular.svg?raw";
import textBulletList from "@fluentui/svg-icons/icons/text_bullet_list_24_regular.svg?raw";
import textBulletListSquare from "@fluentui/svg-icons/icons/text_bullet_list_square_24_regular.svg?raw";
...
import textFontSize from "@fluentui/svg-icons/icons/text_font_size_24_regular.svg?raw";
import textFootnote from "@fluentui/svg-icons/icons/text_footnote_24_regular.svg?raw";
import textIndentDecrease from "@fluentui/svg-icons/icons/text_indent_decrease_24_regular.svg?raw";
import textIndentIncrease from "@fluentui/svg-icons/icons/text_indent_increase_24_regular.svg?raw";
 ...
 * `fluent-button`'s `slot="start"`. The SVGs carry no `fill`, so a container
 * rule (`svg { fill: currentColor }`) themes them with the button's color.
 *
 * Keys cover the standard Office Word ribbon tabs (Home/Insert/Design/Layout/
...
const RIBBON_ICONS: Record<string, string> = {
  ...
  "indent-decrease": textIndentDecrease,
  ...
  mail,
  // Review
  "spell-check": textProofingTools,
  "word-count": calculator,
  "comment-add": commentAdd,
  comment,
  accept: checkmarkCircle,
  ...
  people,
  sync: arrowSync,
  // Draw (inking) — pens, highlighter (reuses `highlight`), eraser, selection
  pen,
  pencil: pen,
  eraser,
  lasso,
  "action-pen": penDismiss,
  "ink-shape": designIdeas,
  board,
  // Insert — illustration extras (online pictures, icon library, 3D models)
